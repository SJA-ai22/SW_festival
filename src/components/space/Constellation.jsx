...
export default function Constellation() {
  ...
  useEffect(() => {
    if (d3Container.current) {
      ...
      var Constellation = { type: 'Constellation' };

      var height = function (c) {
        var c = d3.geoPath(projection.fitWidth(width, Constellation)).bounds(Constellation);
        var x0 = c[0][0];
        var y0 = c[0][1];
        var x1 = c[1][0];
        var y1 = c[1][1];
